...
const Otp = ({history}) => {
    let [user, setUser]= useState ({
     ...
     let handleSubmit = async e =>
     {
         ...
         try {
            ...
            const captchaVerifier= new firebase.auth.RecaptchaVerifier("recaptcha-container");
    ...
    return (
        ...
        <article >
            ...
            <p>Please enter otp and login for a more personalised experience.</p>
            <form onSubmit={ handleSubmit}>
            <div className="form-group">
                 <input type="text"  name="phone" id="phone" value={phone} onChange={handleChange}  required />
                <label htmlFor="phone">Enter Valid Phone Number prefix with +91</label>
            </div>
